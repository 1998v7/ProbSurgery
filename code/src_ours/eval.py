...
from src_ours.heads import get_classification_head
from src_ours.modeling import ImageClassifier, ImageClassifierWithMapping
...
def eval_single_dataset_preprocess_mapping_head(image_encoder, head, dataset_name, args, up_proj, linear_mean, linear_var):
    model = ImageClassifierWithMapping(image_encoder, head, up_proj, linear_mean, linear_var)
    model.eval()
