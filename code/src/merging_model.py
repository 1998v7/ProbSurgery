...
from src.heads import get_classification_head as get_finetuned_classification_head
...
class AlphaWrapper(torch.nn.Module):
    def __init__(self, paramslist, model, names, exam_datasets, args):
        ...
        if self.args.one:
            ...
            self.add_module('feature_mapping_to_head_down_proj', down_proj.to(args.device))
    ...
    def collect_trainable_params(self):
        ...
        if self.args.one:
            down_proj = getattr(self, 'feature_mapping_to_head_down_proj')
